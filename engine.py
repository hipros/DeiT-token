...
from similarity_matrix_plot import calculate_similarity_matrix
...
def CKA_evaluate(data_loader, model, device, similarity_matrix):
    ...
    print("iters: ", len(data_loader), "batch_size: ", data_loader.batch_size, "total: ", len(data_loader)*data_loader.batch_size)
    ...
    return {k: meter.global_avg for k, meter in metric_logger.meters.items()}, similarity_matrix
