...
import torchsummary
import models
import IntermediateVisionTransformer
import IntermediateDistilledVisionTransformer
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='C:\\Users\\dldnj\\Downloads\\deit-main\\data\\', type=str,
                        help='dataset path')
