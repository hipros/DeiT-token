...
@register_model
def intermediate_deit_small_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def intermediate_deit_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def intermediate_deit_base_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
